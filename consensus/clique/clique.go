...
// ecrecover extracts the ESN account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the ESN address
...
// ESN testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // ESN address of the signing key
...
// Author implements consensus.Engine, returning the ESN address recovered
