...
type wizard struct {
	...
	services map[string][]string   // ESN services known to be running on servers
...
// converts it to an ESN address. If an empty line is entered, the default
// value is returned.
