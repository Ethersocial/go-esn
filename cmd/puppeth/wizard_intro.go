...
// setting up a new or managing an existing ESN private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your ESN private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new ESN network down to  |")
	...
	log.Info("Administering ESN network", "name", w.network)
