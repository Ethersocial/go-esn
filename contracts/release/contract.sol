...
// ReleaseOracle is an ESC contract to store the current and previous
// versions of the go-esc implementation. Its goal is to allow Gesc to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new Gesc releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular Gesc release
  struct Version {
  ...
  // updateSigner marks a vote for changing the status of an ESC user, either
