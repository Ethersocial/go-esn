...
type Config struct {
	Oracle common.Address // ESN address of the release oracle
...
func NewReleaseService(ctx *node.ServiceContext, config Config) (node.Service, error) {
	// Retrieve the ESN service dependency to access the blockchain
...
func (r *ReleaseService) checkVersion() {
	...
	if version.Major > r.config.Major ||
		...
		howtofix := fmt.Sprintf("Please check https://github.com/ethersocial/go-esn/releases for new releases")
