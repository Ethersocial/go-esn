...
// valid ESN transaction.
type TransactOpts struct {
	From   common.Address // ESN account to send the transaction from
...
// ESN network. It contains a collection of methods that are used by the
// higher level contract bindings to operate.
type BoundContract struct {
	address    common.Address     // Deployment address of the contract on the ESN blockchain
	abi        abi.ABI            // Reflect based ABI to access the correct ESN methods
...
// DeployContract deploys a contract onto the ESN blockchain and binds the
