...
// entire API provided by go-esn to reduce the maintenance surface and dev
// complexity.
type NodeConfig struct {
	...
	// EthereumEnabled specifies whether the node should run the ESN protocol.
	EthereumEnabled bool

	// EthereumNetworkID is the network identifier used by the ESN protocol to
...
// Node represents a Geth ESN node instance.
type Node struct {
	node *node.Node
}
...
func NewNode(datadir string, config *NodeConfig) (stack *Node, _ error) {
	...
	// Register the ESN protocol if requested
...
// GetEthereumClient retrieves a client to access the ESN subsystem.
