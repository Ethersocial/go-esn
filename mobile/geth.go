...
// NodeConfig represents the collection of configuration values to fine tune the Gesc
...
// Node represents a Gesc ESC node instance.
type Node struct {
	node *node.Node
}

// NewNode creates and configures a new Gesc node.
