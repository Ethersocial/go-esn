...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gesc.ipc", false, filepath.Join(os.TempDir(), "gesc.ipc")},
		{"data", "gesc.ipc", false, "data/gesc.ipc"},
		{"data", "./gesc.ipc", false, "./gesc.ipc"},
		{"data", "/gesc.ipc", false, "/gesc.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gesc.ipc", true, `\\.\pipe\gesc.ipc`},
		{"data", "gesc.ipc", true, `\\.\pipe\gesc.ipc`},
		{"data", `\\.\pipe\gesc.ipc`, true, `\\.\pipe\gesc.ipc`},
	}
